...
addEventListener("trix-initialize", function(event) {
    ...
    var buttonHTML = '<a href="image_link"  class="trix-button" data-trix-attribute="image">image</a>'
    event.target.toolbarElement.
    querySelector(".trix-button-group--file-tools").
    insertAdjacentHTML("beforeend", buttonHTML)

    var buttonHTML = '<a href="embed_link" type="button" class="trix-button " data-trix-attribute="embed">embed</a>'
    event.target.toolbarElement.
    querySelector(".trix-button-group--file-tools").
    insertAdjacentHTML("beforeend", buttonHTML)
})
